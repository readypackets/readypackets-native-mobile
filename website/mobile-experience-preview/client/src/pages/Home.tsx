      ...
      <main id="top">
        <section className="stage" id="experience" style={{ backgroundImage: `linear-gradient(90deg, rgba(5,17,29,.96), rgba(5,17,29,.75) 50%, rgba(5,17,29,.92)), url(${assets.hero})` }}>
          <div className="stage-grid">
            <article className="stage-brief"><p className="eyebrow">Customer application preview</p><h1>ReadyPackets,<br />wherever work happens.</h1><p className="stage-lede">Walk through the completed customer workspace: authorized documents, recorded responses, workflow actions, payment handoff, messages, updates, support, community, and account controls. This permanent preview uses representative local data only.</p><div className="trust-list"><p><span className="brief-status" /><span><b>Customer-complete, administration separate.</b><small>Customers can use the native app or Portal; staff work remains web-only.</small></span></p><p><span className="brief-status" /><span><b>Secure device boundaries.</b><small>Portal-issued permissions, protected files, system-browser identity, and hosted checkout.</small></span></p><p><span className="brief-status" /><span><b>Safe to explore.</b><small>Interact with representative file, audio, update, and account-control states without production contact.</small></span></p></div><span className="data-stamp">Representative local data · not a production account</span></article>
            <Phone />
